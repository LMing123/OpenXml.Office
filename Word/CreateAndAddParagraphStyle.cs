...
namespace Word
{
    public class CreateAndAddParagraphStyle
    {
        public static void CreateParagraphStyle(StyleDefinitionsPart styleDefinitionsPart,string styleID,string styleName,string aliases="")
        {
